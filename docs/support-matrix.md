...
| **Pure SWC / SWC-only Next** | SWC WASM (`swcPlugin: true`) | Webpack loader (same query) | Supported (Next 14.2.x webpack; Turbopack = B2) | [examples/next-swc-poc](../examples/next-swc-poc/); [phase-b-swc.md](./phase-b-swc.md) |
| **Next.js Turbopack** | — | — | Not supported | Query-channel spike planned in Phase B2 |
...
4. **Turbopack** (`next dev --turbo`) is not supported while CSS scoping depends on the webpack loader (B2 planned).
